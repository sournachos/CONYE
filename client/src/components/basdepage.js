...
function BasDePage() {
  return (
    <footer className="social-media-links">
      ...
      {/* <!-- GitHub --> */}
      <a href="https://github.com/sournachos" target="_blank" rel="noreferrer">
    ...
    {/* <!-- LinkedIn --> */}
    <a href="https://www.linkedin.com/in/joseriverathedev/" target="_blank" rel="noreferrer">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
        <path data-name="layer1"
          fill="#202020" d="M3.078 22.331h12.188v36.844H3.078z"></path>
